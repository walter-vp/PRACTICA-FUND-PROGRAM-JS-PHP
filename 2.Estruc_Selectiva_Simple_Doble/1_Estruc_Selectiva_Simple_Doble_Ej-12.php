...
<body>
    <header>
        ...
        <h2 class="centrado">Problema N° 12</h2>
    </header>

    <main>

        <form action="1_Estruc_Selectiva_Simple_Doble_Ej-12.php" method="POST">

            <!-- table>tr>(th.col_izq{Variables}+th.col_der{Valores})^(tr>(td.col_izq>label^td.col_der>input))*2 -->
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="col_der"><input name="txtSuma" id="txtr" type="text" value="<?= $r ?>" readonly></td>
                </tr>
                <tr>
                    <td class="col_izq"></td>
                    <td class="col_der">
