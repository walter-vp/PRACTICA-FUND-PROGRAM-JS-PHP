...
<body>
    <header>
        ...
        <h2 class="centrado">Problema N° 11</h2>
    </header>

    <main>

        <form action="1_Estruc_Selectiva_Simple_Doble_Ej-11.php" method="POST">
            ...
            <table>
                ...
                <tr>
                    <td class="col_izq"><label for="idm">Número Mayor: </label></td>
                    <td class="col_der"><input name="txtm" id="idm" type="text" value="<?= $m ?>" readonly></td>
                </tr>
