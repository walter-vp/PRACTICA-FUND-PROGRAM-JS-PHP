...
<body>
    <header>
        ...
        <h2 class="centrado">Problema N° 20</h2>
    </header>

    <main>

        <form action="1_Estruc_Selectiva_Simple_Doble_Ej-20.php" method="POST">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="col_der"><input type="text" name="txtm_d" id="txtm_d" value="<?= $m_d ?>" readonly></td>
                </tr>
                <tr>
                    <td class="col_izq"><label for="txtm_igv">Monto IGV: </label></td>
